...
mkdir -p ${GOPATH}/src/src/lib/go-oci8
cp -r ${TESTDIR}/* ${GOPATH}/src/src/lib/go-oci8/

go test -v src/lib/go-oci8 -args -disableDatabase=false -hostValid ${DOCKER_IP} -username scott -password tiger
