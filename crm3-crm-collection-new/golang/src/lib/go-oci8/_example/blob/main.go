...
func main() {
	...
	_, err = db.Exec("create table blob_example(id varchar2(256) not null primary key, data clob)")
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	// Over 4000bytes
	b := []byte(strings.Repeat("qwe12asd34", 1000))
