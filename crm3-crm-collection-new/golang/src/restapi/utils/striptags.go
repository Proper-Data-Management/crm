...
func StripTags(html string) string {
	var b bytes.Buffer
	s, c, i, allText := []byte(html), striptag_context{}, 0, true
	...
	for i != len(s) {
		...
		c, i = striptag_context{state: stateTag, element: c.element}, i1
	}
	if allText {
		return html
...
func (c striptag_context) String() string {
	return fmt.Sprintf("{%v %v %v %v %v %v %v}", c.state, c.delim, c.urlPart, c.jsCtx, c.attr, c.element, c.err)
}

// eq reports whether two contexts are equal.
func (c striptag_context) eq(d striptag_context) bool {
...
func (c striptag_context) mangle(templateName string) string {
...
func escapeTemplates(tmpl *Template, names ...string) error {
	...
	for _, name := range names {
		c, _ := e.escapeTree(striptag_context{}, name, 0)
		var err error
		if c.err != nil {
...
type escaper struct {
	...
	output map[string]striptag_context
...
func (e *escaper) escape(c striptag_context, n parse.Node) striptag_context {
	switch n := n.(type) {
...
func (e *escaper) escapeAction(c striptag_context, n *parse.ActionNode) striptag_context {
...
func nudge(c striptag_context) striptag_context {
	switch c.state {
	case stateTag:
...
func join(a, b striptag_context, line int, nodeName string) striptag_context {
...
func (e *escaper) escapeBranch(c striptag_context, n *parse.BranchNode, nodeName string) striptag_context {
...
func (e *escaper) escapeList(c striptag_context, n *parse.ListNode) striptag_context {
	if n == nil {
		return c
	}
...
func (e *escaper) escapeListConditionally(c striptag_context, n *parse.ListNode, filter func(*escaper, striptag_context) bool) (striptag_context, bool) {
...
func (e *escaper) escapeTemplate(c striptag_context, n *parse.TemplateNode) striptag_context {
...
func (e *escaper) escapeTree(c striptag_context, name string, line int) (striptag_context, string) {
...
func (e *escaper) computeOutCtx(c striptag_context, t *template.Template) striptag_context {
...
func (e *escaper) escapeTemplateBody(c striptag_context, t *template.Template) (striptag_context, bool) {
	filter := func(e1 *escaper, c1 striptag_context) bool {
...
func (e *escaper) escapeText(c striptag_context, n *parse.TextNode) striptag_context {
...
func contextAfterText(c striptag_context, s []byte) (striptag_context, int) {
	if c.delim == delimNone {
	...
	return striptag_context{state: stateTag, element: c.element}, i
}
...
// input.
var transitionFunc = [...]func(striptag_context, []byte) (striptag_context, int){
	stateText:        tText,
	stateTag:         tTag,
...
func tText(c striptag_context, s []byte) (striptag_context, int) {
	k := 0
	for {
		...
		if i < k || i+1 == len(s) {
			...
			return striptag_context{state: stateHTMLCmt}, i + 4
		}
		i++
		end := false
		if s[i] == '/' {
		...
		if j != i {
			...
			return striptag_context{state: stateTag, element: e}, j
		}
		k = j
	}
}
...
func tTag(c striptag_context, s []byte) (striptag_context, int) {
	...
	if err != nil {
		return striptag_context{state: stateError, err: err}, len(s)
	}
	...
	return striptag_context{state: state, element: c.element, attr: attr}, j
}

// tAttrName is the context transition function for stateAttrName.
func tAttrName(c striptag_context, s []byte) (striptag_context, int) {
...
func tAfterName(c striptag_context, s []byte) (striptag_context, int) {
...
func tBeforeValue(c striptag_context, s []byte) (striptag_context, int) {
	i := eatWhiteSpace(s, 0)
	if i == len(s) {
		return c, len(s)
	}
...
func tHTMLCmt(c striptag_context, s []byte) (striptag_context, int) {
	if i := bytes.Index(s, commentEnd); i != -1 {
		return striptag_context{}, i + 3
	}
	return c, len(s)
}
...
// element states.
func tSpecialTagEnd(c striptag_context, s []byte) (striptag_context, int) {
	if c.element != elementNone {
		if i := strings.Index(strings.ToLower(string(s)), specialTagEndMarkers[c.element]); i != -1 {
			return striptag_context{}, i
		}
	}
	return c, len(s)
}
...
func tAttr(c striptag_context, s []byte) (striptag_context, int) {
	return c, len(s)
}

// tURL is the context transition function for the URL state.
func tURL(c striptag_context, s []byte) (striptag_context, int) {
...
func tJS(c striptag_context, s []byte) (striptag_context, int) {
	i := bytes.IndexAny(s, `"'/`)
	if i == -1 {
...
// states.
func tJSDelimited(c striptag_context, s []byte) (striptag_context, int) {
	specials := `\"`
	switch c.state {
	case stateJSSqStr:
		specials = `\'`
...
func tBlockCmt(c striptag_context, s []byte) (striptag_context, int) {
...
func tLineCmt(c striptag_context, s []byte) (striptag_context, int) {
...
func tCSS(c striptag_context, s []byte) (striptag_context, int) {
...
func tCSSStr(c striptag_context, s []byte) (striptag_context, int) {
...
func tError(c striptag_context, s []byte) (striptag_context, int) {
	return c, len(s)
}
