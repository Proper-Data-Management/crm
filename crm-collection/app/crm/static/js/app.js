...
MetronicApp.run(['$rootScope', '$urlRouter', '$state','$translate', '$http', '$log','tmhDynamicLocale','amMoment','$filter',
    function ($rootScope, $urlRouter, $state,$translate, $http, $log,tmhDynamicLocale,amMoment,$filter) {
    ...
    $rootScope.$on('$locationChangeStart', function( event ) {
        if ($rootScope.promptExit) {
            var answer = confirm( $filter('translate')('If you leave this page you are going to lose all unsaved changes, are you sure you want to leave?'))
            if (!answer) {
